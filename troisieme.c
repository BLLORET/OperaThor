...
void poly(double a1,double b1, double c1, double d1, double a2, double b2, double c2, double d2)
{
	a1 -= a2;
	b1 -= b2;
	c1 -= c2;
	...
	printf("Voici votre équation remise à 0 : %lfX^3+%lfX²+%lfX+%lf = 0 \n", a1,b1,c1,d1);
	...
	printf("Voici l'équation réecrite : (X-%lf)(%lfX² + %lf) =0",x1,a1,b3,c3);
